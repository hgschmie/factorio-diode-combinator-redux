------------------------------------------------------------------------
-- Diode combinator description editor
------------------------------------------------------------------------
...
---@class dico.DescGui
local Gui = {
    NAME = 'diode-combinator-description-gui',
}
                ...
                children = {
                    {
                        type = 'label',
                        style = 'frame_title',
                        caption = { '', { 'gui-edit-label.edit-description' }, ' - ', { 'entity-name.' .. const.dico_name } },
                        drag_target = 'gui_root',
